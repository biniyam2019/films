...
function Movie() {
  ...
  const [result, setResult] = useState([]); //state of change of submitcheck
  const [obj, setObj] = useState({}); // button click handler to style the button when the button is clicked
